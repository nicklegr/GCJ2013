...
def ris
  STDIN.readline.split.map do |e| e.to_i end
end
...
def rfs
  STDIN.readline.split.map do |e| e.to_f end
end

def rws(count)
  words = []
  for i in 1 .. count
    words << STDIN.readline.chomp
  end
  words
end
